<?php 
  ...
  if(isset($_GET['delete'])){
    ...
    $db->query("UPDATE candidates SET deleted = 1 WHERE id = '$delete_id'");
            ...
            <tr>
              ...
              <td>
                <div class="btn-group btn-group-sm">
                  ...
                  <a href="candidates.php?delete=<?= $id; ?>" class="btn btn-sm btn-outline-danger"><span class="fa fa-trash-alt"></span></a>
                </div>
              </td>
            </tr>
          <?php endwhile; ?>
